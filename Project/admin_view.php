                ...
                <div class="row">
                    <div class="col-md-12 text-center" id="fun"> 
                        <h2><b><i class="fa fa-history"></i><?php echo " ".$WebsiteSiteName." ".$pageName?> </b></h2>
                         <a class="btn btn-lg btn-success" style="font-family: cursive;" id="sp">Admin Records&nbsp;<i class="fa fa-arrow-down"></i></a>
                         <br>
                             <br>
                    </div>
                </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-condensed table-hover text-center" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        $i=1;
                                        $total_fine = 0;
                                        foreach ($issue_return as $info2){
                                            $book_info= get_book_info_by_id($info2['i_book_id']);
                                            $std_info= get_student_info_by_id($info2['i_student_id']);
                                        ...
                                        <tr >
                                            ...
                                            <td><h5><b><?php echo $info2['i_date']; ?></b></h5></td>
                                            
                                            <td><h5><b><?php echo $info2['i_r_date']; ?></b></h5></td>  
                                            <td><h5><b><?php echo $info2['i_fine']; ?></b></h5></td>
                                           
                                            <td><h5><b><?php 
                                            if($info2['i_status']==1){echo '<span class="label label-success" style="font-family: sans-serif; font-size:15px;"><i class="fa fa-check-square"></i> Issued</span>';}
                                        ...
                                        <?php 
                                         $total_fine =  $total_fine+$info2['i_fine'];
