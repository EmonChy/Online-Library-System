    ...
    if($std_info){
        ...
        if($book_info){
            if($book_info['b_qty']>0){
                $s_id=$std_info['s_id'];
                $b_id=$book_info['b_id'];      
                $issue_books= issue_books_new($s_id,$b_id);
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h2><b><i class="fa fa-book"></i> Issue <?php echo $WebsiteSiteName; ?> Books</b></h2> 
                    </div>
                </div>
                 <!-- /. ROW  -->
                    ...
                    <!-- Form Elements -->
                        ...
                        <div class="panel-body">
                            ...
                            <div class="alert alert-success alert-dismissible">
                                ...
                                <h3><b><?php echo $message; ?></b> <a href="issue_books.php"><b>Issue Another</b></a></h3>
                             </div>            
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-4 col-md-offset-4">
                                <button class="btn btn-primary btn-block"><span class="label label-success"><i class="fa fa-send-o"></i></span><b> Confirm Issue</b></button>
                            </div>
                        </form>
                    </div>
