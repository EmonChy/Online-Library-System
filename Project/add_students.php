...
if(isset($_REQUEST['s_email'])&&isset($_REQUEST['s_pass'])){
    ...
    if($s_pass==$s_c_pass){
        ...
        $add_students=add_students($s_name,$s_code,$s_dept,$s_sem,$s_contact,$s_email,$std_picture,$s_password);
        if($add_students){
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h2><b><i class="fa fa-book"></i> Add <?php echo $WebsiteSiteName; ?> Students</b></h2> 
                         <?php
