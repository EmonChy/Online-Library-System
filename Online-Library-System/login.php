                            ...
                            <form role="form" action="" method="post" enctype="multipart/form-data">
                              <b class="text-primary">Admin ID</b>
                               <div class="form-group input-group">
                                  ...
                                  <b><input type="text" name="email" value="" class="form-control" placeholder="Your Employee ID Or Email" required=""/></b>
                              </div>
                              <b class="text-primary">Password</b>
                              <div class="form-group input-group">
                                  <span class="input-group-addon"><i class="fa fa-lock"  ></i></span>
                                  <b><input type="password" name="password" value="" class="form-control"  placeholder="Your Login Password" required=""/></b>
                              </div>
                              <div class="form-group">
                                      ...
                                      <span class="pull-right">
                                          <a href="forgot_password.php" ><b>Forget password ?</b></a> 
                                      </span>
                                  </div>
