...
if(isset($_REQUEST['b_code'])){
    ...
    $b_price = $_REQUEST['b_price'];
        ...
        $add_book=add_books($b_code,$b_name,$b_author,$b_publisher,$b_qty,$b_self,$b_price);
        if($add_book){
            $message='Book Registration Success.';
        }else{
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h2><b><i class="fa fa-book"></i> Add <?php echo $WebsiteSiteName; ?> Books</b></h2> 
                    </div>
                </div>
                 <!-- /. ROW  -->
                 <hr />
                                        ...
                                        <table class="table table-condensed table-striped">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><b><input class="form-control" type="number" name="b_code" placeholder="Enter Code" required="" /></b></td>
                                                </tr>
                                                <tr>
                                                    <td class="text-right"><h5><b>Book Name :</b></h5></td>
                                                    <td><b><input class="form-control" type="text" name="b_name" placeholder="Enter Name" required="" /></b></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td><b><input class="form-control" type="number" name="b_qty" placeholder="Enter Quantity" required="" /></b></td>
                                                </tr>
                                                  <tr>
                                                    <td class="text-right"><h5><b>Book Self :</b></h5></td>
                                                    <td><b><input class="form-control" type="number" name="b_self" placeholder="Enter Self No" required="" /></b></td>
                                                </tr>
                                                  <tr>
                                                    <td class="text-right"><h5><b>Book Price :</b></h5></td>
                                                    <td><b><input class="form-control" type="number" name="b_price" placeholder="Enter price" required="" /></b></td>
                                                </tr>
                                                                                                <tr>
                                                    <td colspan="2" class="text-right">
                                                        <a href="cpanel.php" class="btn btn-danger pull-left"><b><i class="fa fa-reply-all"></i> Back</b></a>
                                                        <button type="submit" class="btn btn-primary"><b><i class="fa fa-send-o"></i> Registration</b></button>
                                                    </td>
                                                </tr>
                                            </tbody>
                                            <tfoot>
