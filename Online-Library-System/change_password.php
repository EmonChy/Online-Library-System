...
if(isset($_POST['tpin'])){
    ...
    $user_password = $user_info['a_password'];
    
    $check_tpin = check_employee_tpin($user_id,$tpin);
    
     if($check_tpin){
         if($old_password==$user_password){
            if($npass==$cpass){
                $new_password=md5($npass);
                $PasswordUpdate = update_employee_password($user_id,$new_password);
                                    ...
                                    <form id="form" action="" method="post" >
                                        <table class="table table-condensed text-left">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="text-right"><h5><b><?php echo $WebsiteSiteName; ?> Transaction PIN :</b></h5></td>
                                                    <td><b><input class="form-control" type="password" name="tpin" placeholder="Enter your 4-Digit <?php echo $WebsiteSiteName; ?> TPIN"  minlength="4" maxlength="4" required="" /></b></td>
                                                </tr>
                                                <tr>
